        ...
        while 1:
            ...
            for fname in window_fnames:
                ...
                try:
                    ...
                    print(f"Error resizing {vidname}: {e}")
                    all_read = False
                    break
            ...
            try:
                ...
                print(f"Error processing {vidname}: {e}")
                continue
...
def save_checkpoint(model, optimizer, step, checkpoint_dir, epoch):
    ...
    checkpoint_path = join(checkpoint_dir, "checkpoint_step{:06d}.pth".format(global_step))
...
if __name__ == "__main__":
    ...
    print(f'syncnet_batch_size = {hparams.syncnet_batch_size}')
    ...
    print(f"-------------------------- nepochs = {hparams.nepochs}")
